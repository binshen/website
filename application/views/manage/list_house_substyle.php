<form id="pagerForm" method="post" action="<?php echo site_url('manage/list_house_substyle')?>">
...
<div class="pageContent">
	<div class="panelBar">
		<ul class="toolBar">
			<li><a class="add" href="<?php echo site_url('manage/add_house_substyle')?>" target="dialog" rel="add_house_substyle" title="新建"><span>新建</span></a></li>
			<li><a class="delete" href="<?php echo site_url('manage/delete_house_substyle')?>/{id}" target="ajaxTodo"  title="确定要删除？" warn="请选择一条记录"><span>删除</span></a></li>
			<li><a class="edit" href="<?php echo site_url('manage/edit_house_substyle/{id}')?>" target="dialog" rel="edit_house_substyle" warn="请选择一条记录" title="查看"><span>查看</span></a></li>
		</ul>
	</div>
